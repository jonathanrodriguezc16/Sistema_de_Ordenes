...
export class OrderService {
    ...
    constructor(inventoryService: InventoryService, orderRepository: IndexedDBOrderRepository) {
    ...
    // Lógica de Negocio: Calcular Totales [cite: 39]
    ...
    async cancelOrder(orderId: string): Promise<void> {
        ...
        if (order.status === 'cancelled') throw new Error("Esta orden ya fue cancelada");
