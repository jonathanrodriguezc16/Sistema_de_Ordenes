    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4">
                                    ...
                                    return (
                                        <li
                                            ...
                                            className={`
                                                ...
                                                ${note.read ? 'bg-white hover:bg-gray-50' : 'bg-blue-50/40 hover:bg-blue-50'}
                                            `}
                                        >
                                            ...
                                            <div className="flex gap-3 items-start pl-2">
                                                ...
                                                `}>
                                                    {isOut ? <AlertCircle size={18} /> : <AlertTriangle size={18} />}
                                                </div>

                                                <div className="flex-1 min-w-0">
                                                    <p className={`text-sm leading-snug ${note.read ? 'text-gray-600 font-medium' : 'text-gray-900 font-bold'}`}>
                                                        {note.message}
                                                    </p>
                                                ...
                                                {/* Botón Check (Visible en hover o si no está leído) */}
                                                {!note.read && (
                                                    <button
            ...
            <button
                ...
                className={`
                    relative p-4 rounded-2xl shadow-xl shadow-blue-900/20 transition-all duration-300 transform hover:scale-105 active:scale-95
